...
I am just compiling a list of resources for people to look at if they are looking for things to work on a volunteer basis which (hopefully) do not require a lot of experience. This list does assume that you are an agentic person and can finness your way into opportunities
...
- [Model Alpha](https://www.modelpha.com) [^1]: Looking for a co-founder or intern, willing to give equity based on skillset and fit. Let Aksshatt (aaki_7 on Discord) know if you are interested!
- [Google Summer of Code (Applications are open)](https://summerofcode.withgoogle.com/) [^11]
- - [CLNx Work Study Positions](https://clnx.utoronto.ca/myAccount/dashboard.htm) [^16] [^17]: If you are studying in the summer then there are a lot of Research Assistant Positions that are open and will be open during the next month that you can apply to
## Internships
It is a little late in the year for Internships but you can still check

- [Simplify Github Repo](https://discord.gg/rsXyruqM6F) [^13] is really good at the beginning of the cycle but it still has some postings
- [Tech Career North](https://discord.gg/rsXyruqM6F) has internships posted everyday on the Canadian channels and there are still some recent postings from what I can see
...
For Research Positions, it is less about your current experiences and more about how driven you are and how you approach the professors. Professors appreciate if you are less experiences but you have a high willingness to learn. I made some slides ([link](https://gamma.app/docs/Networking-for-Research-Opportunities-tdw38k6m9huddnn)) for a presentation about Networking your way into CSSU for a workshop that might be useful. Also look at [Advise on Undergraduate CS Research at UofT](https://alstonlo.github.io/blog/advice-on-cs-research/)[^2]

- [CSC 494 / 495 Board](https://utoronto.sharepoint.com/sites/ArtSci-DCS-Undergrad/Lists/Research%20Projects/AllItems.aspx?viewid=bca247bb-c1ca-4e72-9929-d0183090b483&env=WebViewList&startedResponseCatch=true): These are all the professors that were looking for students to work with for 4th year course credit. Since these professors are looking to get students for credit, there is a high chance they would also be happy to take volunteers. The list specifies the niches of each of the professors within CS as well so you can choose what you like. I personally would not recommend taking these courses in the summer if you are international
...
- [DGP Lab](https://www.dgp.toronto.edu/) is one of the best labs in the world when it comes to computer graphics and the p[people list](https://www.dgp.toronto.edu/people-gallery) for it is definetely worth looking into
- [KITE at UHN](https://kite-uhn.com/labs) [^16] is fairly flexible when it comes to first year students
...
- [Zhijing Jin](https://zhijing-jin.com/home/) [^5]
- [Chi-Guhn Lee](https://cglee.mie.utoronto.ca/) [^14]: Zac is part of this lab 
- [Baochun Li](https://iqua.ece.toronto.edu/bli/) [^15]: Elwin worked here in his second year by cold emailing the prof
...
- [Isabelle Rao](https://www.mie.utoronto.ca/faculty_staff/isabelle-rao/) [^9] If you have some confidence in Python and Data Processing
- [Scott Sanner (Data-Driven Decision Making Lab)](https://d3m.mie.utoronto.ca/members/ssanner/) [^9]
...
If you cannot find an opportunity there are a lot of resources out there that you can use to build projects

- [Net Ninja](https://www.youtube.com/@NetNinja) for SWE
- [sentdex](https://www.youtube.com/@sentdex) for Pytorch + NNFS
- [Andrej Karpathy's Neural Networks: Zero to Hero](https://www.youtube.com/playlist?list=PLAqhIrjkxbuWI23v9cThsA9GvCAUhRvKZ)
- [StatQuest for NN / ML](https://www.youtube.com/@statquest/featured) [^13]
