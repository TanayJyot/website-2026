...
- There are [[PUMP 2 - Knowledge Base - axioms]] that limit what a set can be. 
	- The existence of an empty set 
	- the existence of an infinite set 
- A set has a [[PUMP 2 - Knowledge Base - cardinality]]
$$a\in A $$ would mean a belongs to A
- Basically a is a part of the set “A”
- [[PUMP 2 - Knowledge Base - empty set]]
- A set within a set is denoted by placing it within it. 
- The [[PUMP 2 - Knowledge Base - empty set]] is not equal to the set of the empty set. 
- $$\emptyset \neq \{\emptyset \}$$
- This would have a [[PUMP 2 - Knowledge Base - cardinality]] of 1. 
- ## Examples:
![[Pictures - Pasted image 20230713000742.png]]

- [[Pictures - Transitiveness of sets]]
- [[PUMP 2 - Knowledge Base - Equality of Sets]]
- [[PUMP 2 - Knowledge Base - Russell’s paradox]]
- [[PUMP 2 - Knowledge Base - Set symbols]]
# Subsets:
## Definition:
...
- We often express this in terms of [[PUMP 2 - Knowledge Base - Proper subset]]
...
### 4. 
According to the [[PUMP 2 - Knowledge Base - Russell’s paradox]], $$ A \in A $$ is always false. However, $$ A\subseteq A $$
is always true. 
...
### 5. [^1]
[[PUMP 2 - Knowledge Base - Equality of Sets#Subset Way]]

### 6. 
$$ B \subseteq A \Rightarrow |B| \le |A|$$
If B is the subset of A. The [[PUMP 2 - Knowledge Base - cardinality]] of B must be less than or equal to the cardinality of A. 
...
## .
[[PUMP 2 - Knowledge Base - De Morgan’s Law]]
...
# Numbers 
[[PUMP 2 - Knowledge Base - Numbers and Number Sets 1]]
