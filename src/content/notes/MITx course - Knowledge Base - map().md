...
___
We can also apply [[MITx course - Knowledge Base - map()]] to **n-ary** functions. The functions that need more that one argument. 
...
# Outputs [10, 9, 11, 12]
```
In this case, python compares the value of each of the element in order via [[MITx course - Knowledge Base - Indexing]]. So the 0th element of list 1 and list 2 are compared and 10 is printed. 
