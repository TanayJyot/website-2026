...
- Tuples are [[MITx course - Knowledge Base - immutable]] just like [[MITx course - Python Basics - Core Elements Of Programs#Strings]]
- We use () to represent 
...
- You can do [[MITx course - Python Basics - Core Elements Of Programs#Iteration]] over tuples 
```python
counter = 0 
...
- They follow an [[MITx course - Knowledge Base - ordered sequence]].
- Denoted by \[]. 
...
- Unlike [[MITx course - Structured Types - Tuples and Lists#Tuples]], lists are [[MITx course - Knowledge Base - Mutability]].

# List Operations

## To add elements:
- [[MITx course - Knowledge Base - list.append]]
- We use the ‘.‘ as a means to access data. 
- [[MITx course - Knowledge Base - Concatenation]]
- [[MITx course - Knowledge Base - extend list]]

## To remove elements:

- [[MITx course - Knowledge Base - del command]]
- [[MITx course - Knowledge Base - list.pop()]]
- [[MITx course - Knowledge Base - remove (list)]]

## Convert lists to strings and back 
- [[MITx course - Knowledge Base - list()]]
- [[MITx course - Knowledge Base - split string for list]]
- [[MITx course - Knowledge Base - join for list to string]]

## Other List Operations 
### Sort a list:
- [[MITx course - Knowledge Base - sorted()]]
- [[MITx course - Knowledge Base - sort list]]
### Reverse a list:
- [[MITx course - Knowledge Base - reverse list]]
### Other functions:
...
- [[MITx course - Knowledge Base - range()#How Range works]]
...
# Outputs ['Tanay', 'Jyot', 'Singh', 'Chawla'] ['Tanay', 'Jyot', 'Singh']
```
- I think this is happening because we are using’[:] to denote [[MITx course - Knowledge Base - Slicing]]. 
...
- Sometimes you would wanna use [[MITx course - Knowledge Base - Concatenation]] to ensure that lists don’t stick together permanently. 
...
- In programming, we consider functions to be [[MITx course - Knowledge Base - first class objects]].
- [[MITx course - Simple Programs - Functions]] can be used within lists to do something in them. 
- Python provides a general purpose way of doing such **higher order programming** using [[MITx course - Knowledge Base - map()]] 