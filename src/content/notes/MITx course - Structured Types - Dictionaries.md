...
- Get ‘i th’ element seq\[i]. [[MITx course - Knowledge Base - Indexing]]
- [[MITx course - Knowledge Base - len()]]                                         
- [[MITx course - Knowledge Base - Concatenation]](not range)
- [[MITx course - Knowledge Base - Successive Concatenation]](not range)
- [[MITx course - Knowledge Base - Slicing]]
-  Use ‘in’ to check if element in sequence
- [[MITx course - Python Basics - Core Elements Of Programs#Iteration]] using for and in.
___
...
- It is [[MITx course - Knowledge Base - Mutability]].
- [[MITx course - Knowledge Base - del command]] can be used to remove an entry.
- [[MITx course - Knowledge Base - keys method]]
- [[MITx course - Knowledge Base - values method]]
___
- Values in a dictionary can be anything. 
- Key must be 
	- unique.
	- [[Hashable]] which all [[MITx course - Knowledge Base - immutable]] types are. 
	- Use float as a key with caution.
- An [[MITx course - Knowledge Base - immutable]] type is necessary in a key because if we change the key, then we cannot expect to find the value associated with it. 
![[MITx course - Pictures - Pasted image 20230601173931.png]]
...
- ![[MITx course - Pictures - Pasted image 20230603183155.png]]
