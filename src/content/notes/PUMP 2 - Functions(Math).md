...
For a function $\mathcal{f} : A \rightarrow B$ would mean that the function maps elements from A into B. Here A is called the [[domain(mathematics)]] of the function and B is called the [[codomain(mathematics)]]. ![[Pictures - Pasted image 20230802183739.png]] ^e9f736
...
## Example:
![[Pictures - Pasted image 20230802184642.png]]
...
> Let a,b be [[PUMP 2 - Sets]]. A function $f:A \rightarrow B$ is a unique assignment of each element of A to an element of B
...
## Basic Terminology:
![[PUMP 2 - Functions(Math)#^e9f736]]
[[range of a function]]

![[Excalidraw - Drawing 2023-08-20 15.28.36.excalidraw]]
If $f(a) = b$ 
...
## [[MAT137 - Videos - 4.1, 4.2]]

- This is the same as [[PUMP 2 - Functions(Math)#Definition 1]]
