...
- if either of precision or recall are set to 0[^1] (this would happen when there are no relevant documents out of the retrieved documents) then the f-measure gets the default value of 0
