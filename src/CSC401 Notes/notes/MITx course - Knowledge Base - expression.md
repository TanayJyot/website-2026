...
- So the [[MITx course - Knowledge Base - interpreter]] evaluates an expression. 
## How we represent one
- contains everything that is an [[MITx course - Knowledge Base - expression]]. 
- Used to do anything that an [[MITx course - Knowledge Base - expression]] does.
